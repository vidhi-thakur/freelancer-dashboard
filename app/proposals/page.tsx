...
import { Plus, Wand2, FileText, Download, Send, Eye, MoreHorizontal, Loader2 } from "lucide-react"
...
const clients = ["TechCorp Inc.", "StartupXYZ", "Creative Agency", "Digital Solutions"]
      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <div className="flex flex-1 items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Create winning proposals with AI assistance</p>
          </div>
            ...
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setNewProposal({ ...newProposal, client: value })}
                    >
                      <SelectTrigger>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setNewProposal({ ...newProposal, projectType: value })}
                    >
                      <SelectTrigger>
                ...
                <div className="flex justify-center">
                  <Button onClick={generateProposal} disabled={isGenerating} className="w-full max-w-sm">
                    {isGenerating ? (
                      <>
                ...
                {newProposal.generatedContent && (
                  <div className="grid gap-2">
                    <Label htmlFor="generatedContent">Generated Proposal</Label>
                    <Textarea
                      id="generatedContent"
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={handleCreateProposal} disabled={!newProposal.generatedContent}>
                  Save Proposal
                </Button>
              </div>
            </DialogContent>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">{proposal.client}</p>
                  </div>
                  <DropdownMenu>
